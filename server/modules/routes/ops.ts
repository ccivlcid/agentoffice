...
import { registerOpsSettingsAndStats } from "./ops/settings-stats.ts";
import { registerOpsApiProviders } from "./ops/api-providers.ts";
import { registerOpsTaskReports } from "./ops/task-reports.ts";
import { registerOpsCliUsage } from "./ops/cli-usage.ts";
import { registerOpsWorktrees } from "./ops/worktrees.ts";
import { registerOpsCliModels } from "./ops/cli-models.ts";
import { registerOpsSkillsList } from "./ops/skills-list.ts";
import { registerOpsSkillsLearn } from "./ops/skills-learn.ts";
...
import { registerOpsMcpServers } from "./ops/mcp-servers.ts";
import { registerOpsRules } from "./ops/rules.ts";
import { registerOpsMcpRegistry } from "./ops/mcp-registry.ts";
...
export function registerRoutesPartC(ctx: RuntimeContext): RouteOpsExports {
  ...
  registerOpsSettingsAndStats(__ctx);
  registerOpsApiProviders(__ctx);
  registerOpsTaskReports(__ctx);
  registerOpsWorktrees(__ctx);
  const cliUsageExports = registerOpsCliUsage(__ctx);
  registerOpsCliModels(__ctx);
  registerOpsSkillsList(__ctx);
  registerOpsSkillsLearn(__ctx);
  registerOpsSkillDocuments(__ctx);
  registerOpsMcpServers(__ctx);
  registerOpsRules(__ctx);
  registerOpsMcpRegistry(__ctx);
  ...
  return {
    ...
    refreshCliUsageData: cliUsageExports.refreshCliUsageData,
  };
}
