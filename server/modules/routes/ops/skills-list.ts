// @ts-nocheck
/**
 * Skills list and detail (GET /api/skills, GET /api/skills/detail) — skills.sh cached proxy.
 */
...
export function registerOpsSkillsList(ctx: RuntimeContext): void {
  const { app } = ctx;
  ...
  app.get("/api/skills/detail", async (req: any, res: any) => {
