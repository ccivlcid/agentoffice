# HyperClaw v1.2.0 Release Notes
...
- **Classroom training animation** — Uploading a custom skill triggers a full-screen chalkboard classroom animation showing the HyperClaw mascot as teacher and CLI representative agents as students.
