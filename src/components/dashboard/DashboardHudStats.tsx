...
import { ClipboardList, CheckCircle2, Users, Zap, ChevronDown, ChevronUp } from "lucide-react";
...
export default function DashboardHudStats({
  ...
  const toggleLabel = folded ? t({ ko: "KPI 펼치기", en: "Expand KPI" }) : t({ ko: "KPI 접기", en: "Collapse KPI" });
  ...
  return (
    <div className="relative">
      ...
      {onQuickActionClick && (reviewQueue > 0 || inProgressTasks > 0) && (
        <div className="mt-3 flex flex-wrap items-center gap-2">
          {reviewQueue > 0 && (
            ...
            >
              ...
              {t({ ko: "건", en: "" })} <span aria-hidden>→</span>
            </button>
          )}
          {inProgressTasks > 0 && (
            <button
