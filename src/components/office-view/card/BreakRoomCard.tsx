...
export default function BreakRoomCard({
  ...
  return (
    <article
      className="flex flex-col overflow-hidden rounded-2xl border border-dashed border-slate-600/50 bg-slate-800/30 shadow-sm shadow-slate-950/20 transition-all duration-200 hover:border-slate-500/60 hover:shadow-md hover:shadow-slate-950/15"
